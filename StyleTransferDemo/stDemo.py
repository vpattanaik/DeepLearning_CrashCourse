...
cImPath = './data/base.jpeg'
sImPath = './data/style.jpeg'
genImOutputPath = './results/st_output.jpeg'
...
def get_style_loss(ws, Gs, As):
    ...
    for w, G, A in zip(ws, Gs, As):
        ...
        sLoss = sLoss + w*0.25*K.sum(K.square(G_gram - A_gram))/ (N_l**2 *
                                                                 M_l**2)
    return sLoss
